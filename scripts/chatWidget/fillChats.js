...
const fillChats = function() {
    ...
    DB.messages.forEach(msg => {
        ...
        chatMsgDomString += `
            <p class="chatWidget__msg" data-id="msg_${msg.id}"><span class="chatWidget__author">${messageAuthor.userName}:</span><span class="chatWidget__msg"> ${msg.content}</span><button class="chatWidget__editBtn" id="btn_${msg.id}">Edit</button></p>
            `
    })
